...
<body class="bg-gray-50 flex items-center justify-center min-h-screen font-sans">
    ...
    <div class="w-full max-w-md my-10">
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-4">
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-1">{{ __('Nama Lengkap') }}</label>
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-1">{{ __('Konfirmasi Password') }}</label>
        ...
        <div class="my-6">
            <div class="relative">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class="px-2 bg-white text-gray-400">{{ __('atau daftar cepat dengan') }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="text-center mt-6">
            <p class="text-sm text-gray-500 mb-3">{{ __('Sudah punya akun?') }}</p>
            <a href="{{ route('login') }}"
