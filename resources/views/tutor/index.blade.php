    ...
    @auth
        @if(isset($application) && $application && $application->status === 'pending')
            <div class="bg-yellow-100 text-yellow-700 p-4 rounded-xl mb-6">
                {{ __('⏳ Pengajuan kamu sedang direview') }}
            </div>
        @endif
    @endauth
    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-8">
        ...
        <div>
            ...
            <p class="text-gray-500 mt-2">
                {{ __('Belajar langsung dengan tutor berpengalaman untuk mempersiapkan SNBT.') }}
            </p>
        </div>
            ...
            <div class="col-span-3">
                <div class="bg-white rounded-2xl shadow p-10 text-center">
                    ...
                    <p class="text-gray-500">
                        {{ __('Tutor yang telah disetujui akan muncul di sini.') }}
                    </p>
                </div>
            </div>
        @endforelse
