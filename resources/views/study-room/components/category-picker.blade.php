...
<div id="{{ $scope }}CategoryPicker"
    ...
    <div class="grid grid-cols-3 gap-2 sm:gap-3">
        ...
        <button type="button"
            ...
            <span class="hidden sm:block text-xs text-gray-400 text-center">{{ __('Tes Potensi Skolastik') }}</span>
        </button>
        ...
        <button type="button"
            ...
            <span class="hidden sm:block text-xs text-gray-400 text-center">{{ __('Matematika') }}</span>
        </button>
        ...
        <button type="button"
            ...
            <span class="hidden sm:block text-xs text-gray-400 text-center">{{ __('Bahasa Indonesia') }}</span>
        </button>
